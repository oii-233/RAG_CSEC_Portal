    ...
    <div className="min-h-screen bg-[#F4F8FA] flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white rounded-[40px] shadow-2xl overflow-hidden border border-gray-100 p-2">
        <div className="bg-[#17A2B8] p-12 rounded-[36px] text-white text-center relative overflow-hidden">
          ...
          <h2 className="text-3xl font-black uppercase tracking-tighter">Unified Access</h2>
        ...
        <form onSubmit={handleSubmit} className="p-10 space-y-8">
          <div className="flex bg-gray-50 p-1.5 rounded-2xl border border-gray-100">
            <button
              ...
              className={`flex-1 py-4 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] transition-all ${
                role === UserRole.STUDENT ? 'bg-white shadow-xl text-[#17A2B8] border border-gray-100' : 'text-gray-400 hover:text-gray-600'
              }`}
            >
              Student
            </button>
            <button
              ...
              className={`flex-1 py-4 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] transition-all ${
                role === UserRole.ADMIN ? 'bg-white shadow-xl text-[#17A2B8] border border-gray-100' : 'text-gray-400 hover:text-gray-600'
              }`}
            >
              Admin
            </button>
          ...
          <div className="space-y-5">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Institutional ID / Email</label>
              <input
                type="email"
                value={email}
